...
//     const user = new User({ fullName, email, password: hashedPassword, role: (role || "citizen").toLowerCase() });
//     await user.save();
...
//         // FIX: Add a null check for 'creator' before accessing its properties.
...
// mongoose.connect(process.env.MONGO_URI || "mongodb://localhost:27017/petitionapp", { useNewUrlParser: true, useUnifiedTopology: true })
//   .then(() => {

...
//                                 <div key={petition._id} className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-200 flex flex-col">
...
//                                         // If it's the user's petition, show Edit and Delete buttons
//                                         <div className="flex items-center gap-3">
//                                           <button 
//                                             onClick={() => handleEdit(petition)} 
//                                             className="flex-1 py-2.5 px-4 rounded-lg text-sm font-medium bg-amber-100 text-amber-800 hover:bg-amber-200 transition-all flex items-center justify-center gap-1.5"
//                                           >
...
//                                             className="flex-1 py-2.5 px-4 rounded-lg text-sm font-medium bg-red-100 text-red-800 hover:bg-red-200 transition-all flex items-center justify-center gap-1.5"
//                                           >
...
//                                         </div>
//                                       ) : (
//                                         // Otherwise, show the Sign Petition button
//                                         <button 

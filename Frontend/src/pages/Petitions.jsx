...
// import { AlertCircle, Clock, Edit2, FileText, Filter, MapPin, Search, Trash2, Users, X } from 'lucide-react';
// import API from '../api';
...
//           <p className="text-sm text-gray-600 mb-6">This popup will close automatically in 3 seconds</p>
//           <button
//             onClick={onClose}
...
//           />
//         )}
//         <PetitionForm isEditing={currentView === 'edit'} />
//       </>
//     );
//   }
...
//                       disabled={petition.isMyPetition || petition.hasSigned}
//                       className={`flex-1 sm:flex-2 py-3 px-4 rounded-lg text-sm font-semibold transition-all duration-200 ${
//                         petition.isMyPetition
...
//                         className="flex-1 py-2.5 px-4 rounded-lg text-sm font-medium bg-amber-100 text-amber-800 hover:bg-amber-200 hover:text-amber-900 transition-all duration-200 hover:shadow-sm flex items-center justify-center gap-1.5"
//                       >
...
//                         className="flex-1 py-2.5 px-4 rounded-lg text-sm font-medium bg-red-100 text-red-800 hover:bg-red-200 hover:text-red-900 transition-all duration-200 hover:shadow-sm flex items-center justify-center gap-1.5"
//                       >
...
//                   <div key={petition._id} className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
//                     <div className="flex justify-between items-start mb-3">
//                       <span className={`px-3 py-1 rounded-full text-xs font-medium ${
//                         petition.category === 'environment' ? 'bg-green-100 text-green-800' :
//                           petition.category === 'transportation' ? 'bg-blue-100 text-blue-800' :
...
// // --- NEW Component: Confirm Delete Popup ---
...
//     // ... Your PetitionForm component code remains unchanged ...
//     <div className="flex-1 p-6">
//     <div className="max-w-4xl mx-auto">
//       <div className="flex items-center justify-between mb-6">
//         <div>
...
//     const currentView = searchParams.get('view');
//     // ... all other functions like getUserId, useEffects, etc. remain unchanged
...
//     // 2. This function is called when the user confirms the deletion
...
//     // ... other variables like isFormValid, filteredPetitions, etc. remain unchanged
//     const isFormValid = formData.title && formData.category && formData.location && formData.description;
//     const activePetitions = petitions.filter(p => p.status === 'active').length;
//     const myPetitions = petitions.filter(p => p.isMyPetition).length;
//     const signedPetitions = petitions.filter(p => p.hasSigned && !p.isMyPetition).length;
...
//     // --- The entire return statement with all views ---
//     if (currentView === 'create' || currentView === 'edit') {
//         return (
//             <>

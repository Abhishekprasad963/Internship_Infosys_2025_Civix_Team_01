          ...
          <div className="bg-green-50 rounded-xl p-4 sm:p-6 w-full h-full">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6 sm:mb-8">
              <div className="relative w-16 h-16 sm:w-20 sm:h-20">
                <img
                  src={profilePic || defaultProfileIcon}
                  alt="Profile"
                  className="w-16 h-16 sm:w-20 sm:h-20 rounded-full object-cover cursor-pointer border-2 border-gray-200 bg-gray-100"
                  onClick={() => setShowModal(true)}
                />
                <input
                  type="file"
            ...
            {showModal && (
              <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
                <div className="relative text-center bg-white rounded-lg p-4 sm:p-6 max-w-full">
                  <img
                    src={profilePic || defaultProfileIcon}
                    alt="Profile Full"
                    className="max-w-[85vw] max-h-[60vh] sm:max-w-[70vw] sm:max-h-[70vh] rounded-lg shadow-lg mx-auto bg-gray-100"
                  />
                  <button
                    onClick={() => setShowModal(false)}
                    className="absolute top-2 right-2 bg-red-500 text-white px-2 sm:px-3 py-1 rounded-lg text-sm"
                  >
                    Close
                  </button>
          ...
          <div className="bg-green-50 rounded-xl p-4 sm:p-6">
            ...
            <form onSubmit={handlePasswordUpdate} className="space-y-4">
              <input
                ...
                value={currentPassword}
                onChange={(e) => setCurrentPassword(e.target.value)}
                className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-100 rounded-lg text-sm sm:text-base"
              />
              <input
                type="password"
                placeholder="New Password"
